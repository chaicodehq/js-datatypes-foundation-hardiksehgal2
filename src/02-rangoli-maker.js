...
export function repeatPattern(pattern, times) {
  if (typeof pattern !== "string" || times < 0 || !Number.isInteger(times) || typeof times !== "number") {
    return ""
  }
...
export function replaceRangoliColor(design, oldColor, newColor) {
  if (typeof design !== "string" || typeof oldColor !== "string" || typeof newColor !== "string" || oldColor.trim().length === 0) {
    return ""
  }
