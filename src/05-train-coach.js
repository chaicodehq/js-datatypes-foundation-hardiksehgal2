...
export function findPassenger(passengers, name) {
  ...
  return passengers.find((passenger) => typeof passenger.name === "string" && passenger.name.toLowerCase() === name.toLowerCase())
}
...
export function getPassengerIndex(passengers, name) {
  ...
  return passengers.findIndex((passenger) => typeof passenger.name === "string" && passenger.name.toLowerCase() === newName)
}
